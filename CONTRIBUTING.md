# Contributing to React Picture Selector

Thank you for considering contributing to React Picture Selector! I appreciate your interest in making this project better.
...
3. Submit a pull request to the main repository's `dev` branch.
